 ...
 */
package com.easyspring.core.design.mvc.standard.dao;
...
public interface BaseDao<K, M extends Model<K>> {
     ...
     * @date 2020/5/15 15:24
     */
    Integer batchDelete(@Param(value = "ks") List<K> ks, @Param(value = "u") AuthorizationUser u);
     ...
     * @date 2020/5/15 15:28
     */
    Boolean updateNull(@Param(value = "k") K k, @Param(value = "m") M m, @Param(value = "u") AuthorizationUser u);
}
