...
import com.easyspring.core.design.mvc.simple.dao.BaseDao;
...
public abstract class AbstractService<K, M extends AbstractModel<K>> implements BaseService<K, M> {
    ...
    protected static<K, M1 extends AbstractModel, M2 extends AbstractModel> void mappingObject(List<M1> list1, List<M2> list2, GetCallback<M1, K> getKeyCallback1, GetCallback<M2, K> getKeyCallback2, SetCallback<M1,M2> setValueCallback1){
    ...
    protected static<K, M1 extends AbstractModel, M2 extends AbstractModel> void mappingList(List<M1> list1, List<M2> list2, GetCallback<M1, K> getKeyCallback1, GetCallback<M2, K> getKeyCallback2, SetCallback<M1,List<M2>> setValueCallback1){
        if(list1!=null && list2!=null){
