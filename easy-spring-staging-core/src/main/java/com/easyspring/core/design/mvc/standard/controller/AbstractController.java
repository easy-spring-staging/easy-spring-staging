 ...
 */
package com.easyspring.core.design.mvc.standard.controller;
...
public abstract class AbstractController {
    protected static final String DEFAULT_QUERY_METHOD_NAME = "query";
    protected static final String DEFAULT_COUNT_METHOD_NAME= "count";
    ...
    /**
    protected void builderSortModel(RequestModel rm, Map<String,String> orderColumnMap){
        if(rm != null && orderColumnMap!=null){
            Object orderObj = rm.get(SortModel.DATA_LIST_ORDER_PARAM_NAME);
            if(orderObj!=null){
                String orderParamName = null;
                try {
                    orderParamName = (String) orderObj;
                }catch (Exception e){};
                if(orderParamName!=null){
                    SortModel sortModel = SortModel.getInstance(orderParamName,orderColumnMap);
                    if(sortModel!=null){
                        rm.put(SortModel.DATA_LIST_ORDER_PARAM_NAME,sortModel);
                    }else {
                        rm.put(SortModel.DATA_LIST_ORDER_PARAM_NAME,null);
                    }
                }
