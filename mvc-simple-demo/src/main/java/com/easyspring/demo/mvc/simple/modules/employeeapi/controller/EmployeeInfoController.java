...
public class EmployeeInfoController extends AbstractController {
    ...
    public ResponseModel<Page<EmployeeInfo>> queryPage() throws Exception {
        QueryParameter q = builderRequestModel(DEFAULT_QUERY_PAGE_METHOD_NAME);
        builderSort(q);
        return ResponseModel.success(employeeInfoService.queryPage(q, getUser()));
    }
    ...
    public ResponseModel<EmployeeInfo> queryDetails(@PathVariable(value = "id") String id) throws Exception {
        return ResponseModel.success(employeeInfoService.queryDetails(id, getUser()));
    }
    ...
    public ResponseModel<String> add(@RequestBody EmployeeInfo employeeInfo) throws Exception {
        return ResponseModel.success(employeeInfoService.add(employeeInfo, getUser()));
    }
    ...
    public ResponseModel<Boolean> editAll(@PathVariable(value = "id") String id, @RequestBody EmployeeInfo employeeInfo) throws Exception {
        return ResponseModel.success(employeeInfoService.editAll(id, employeeInfo, getUser()));
    }
    ...
    public ResponseModel<Boolean> edit(@PathVariable(value = "id") String id, @RequestBody EmployeeInfo employeeInfo) throws Exception {
        return ResponseModel.success(employeeInfoService.edit(id, employeeInfo, getUser()));
    }
    ...
    public ResponseModel<Boolean> remove(@PathVariable(value = "id") String id) throws Exception {
        return ResponseModel.success(employeeInfoService.remove(id, getUser()));
    }
    ...
    public ResponseModel<Integer> removeMulti(@RequestParam(value = "ids") List<String> ids) throws Exception {
        return ResponseModel.success(employeeInfoService.removeMulti(ids, getUser()));
    }
